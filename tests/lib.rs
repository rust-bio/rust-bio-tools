...
fn test_vcf_report_with_custom_js() {
    ...
    let result = "tests/test-vcf-report-with-custom-js/js/math.min.js";
    let expected = "tests/expected/report/math.min.js";
